...
interface ItemProps {
  ...
  value: string | globalThis.File | string[] | null;
  onChange: (name: keyof AddItemValues, value: string | globalThis.File | string[] | null) => void;
}
...
const AddItem: React.FC = () => {
  ...
  const handleChange = (name: keyof AddItemValues, value: string | File | string[] | null) => {
