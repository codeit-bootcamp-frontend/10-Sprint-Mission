...
export const validatePassword = (inputElement, messageElement) => {
  ...
  if(password === '') {
    showMessage(validationMessage.requiredPassword, messageElement, inputElement);
    return;
  }
...
export const validateNickname = (inputElement, messageElement) => {
  ...
  if(nickname === '') {
    showMessage(validationMessage.requiredNickname, messageElement, inputElement);
    return;
  }
...
export const validatePasswordCheck = (inputElement, messageElement, confirmPassword) => {
  ...
  if(passwordCheck !== confirmPassword) {
    showMessage(validationMessage.mismatchedPassword, messageElement, inputElement);
    return;
  }
